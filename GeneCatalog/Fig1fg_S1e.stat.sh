...
grep "DSM_0" final_20_50_g2g.list | grep "Soil_" | grep "OM-RGC.v2" | wc -l        ####1226110
grep "DSM_0" final_20_50_g2g.list | grep "Soil_" | grep -v "OM-RGC.v2" | wc -l     ####2359451
grep "DSM_0" final_20_50_g2g.list | grep -v "Soil_" | grep  "OM-RGC.v2" | wc -l    ####1467212
grep -v "DSM_0" final_20_50_g2g.list | grep "Soil_" | grep  "OM-RGC.v2" | wc -l    ####51245
grep "DSM_0" final_20_50_g2g.list | grep -v "Soil_" | grep  -v "OM-RGC.v2" | wc -l ####58105982
grep -v "DSM_0" final_20_50_g2g.list | grep "Soil_" | grep  -v "OM-RGC.v2" | wc -l ####17964801
grep -v "DSM_0" final_20_50_g2g.list | grep -v "Soil_" | grep  "OM-RGC.v2" | wc -l ####2707314
###Relevant statistical results for Fig S1F
grep "," final_20_50_g2g.list | grep "DSM_0" |  grep -v "Soil_" |  grep  -v "OM-RGC.v2" | wc -l   ###17811094
grep "," final_20_50_g2g.list | grep "Soil_" | grep -v "DSM_0" |  grep  -v "OM-RGC.v2" | wc -l    ###3841389
grep "," final_20_50_g2g.list | grep "OM-RGC.v2" |  grep -v "Soil_" | grep -v "DSM_0" | wc -l     ###688319

...
mydata <- read.csv("Fig3B.csv")

my_comp <- list(c("AF2_1", "DS_1"),c("DS_1", "OM_1"),c("DS_1", "TS_1"),c("AF2_2", "DS_2"),c("AF2_2", "OM_2"),c("AF2_2", "TS_2"),c("DS_2", "OM_2"),c("DS_2", "TS_2"))

pdf("Fig3B_violin_boxplot.pdf",w = 6.5,h = 6.5)
mydata$Group <- factor(mydata$Group,levels=c("AF2_1","DS_1","OM_1","TS_1","AF2_2","DS_2","OM_2","TS_2"))
